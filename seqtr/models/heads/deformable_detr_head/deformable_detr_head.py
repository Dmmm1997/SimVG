...
class DeformableDETRHead(nn.Module):
    def __init__(
        ...
        self.transformer = DeformableDetrTransformer(
        ...
        matcher = HungarianMatcher(
            cost_class=2.0, cost_bbox=5.0, cost_giou=2.0, cost_class_type="focal_loss_cost", alpha=0.25, gamma=2.0
        )
        ...
        num_pred = (self.transformer.decoder.num_layers + 1) if as_two_stage else self.transformer.decoder.num_layers
        if with_box_refine:
