...
model = dict(
    ...
    head=dict(
        ...
        branch_loss_weight={"decoder_gt": 1.0, "token_gt": 0.0, "decoder_predict": 1.0},
        predict_weight=True,
    ),
)
...
work_dir = "work_dir/beit3_multibranch/(3-11)decodergt#0.0decoderpredict#1.0tokengt_30ep_withweight"
