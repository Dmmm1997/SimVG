...
model = dict(
    ...
    head=dict(
        ...
        branch_loss_weight={"decoder_gt": 1.0, "token_gt": 1.0, "decoder_predict": 0.1}, 
...
work_dir = "work_dir/beit3_multibranch/iou_score_decodergt#1decoderpredict#1tokengt_30ep"
