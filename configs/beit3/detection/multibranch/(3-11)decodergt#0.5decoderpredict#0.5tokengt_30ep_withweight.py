...
model = dict(
    ...
    head=dict(
        ...
        branch_loss_weight={"decoder_gt": 1.0, "token_gt": 0.5, "decoder_predict": 0.5},
        predict_weight=True,
    ),
)
...
work_dir = "work_dir/beit3_multibranch/(3-11)decodergt#0.5decoderpredict#0.5tokengt_30ep_withweight"
