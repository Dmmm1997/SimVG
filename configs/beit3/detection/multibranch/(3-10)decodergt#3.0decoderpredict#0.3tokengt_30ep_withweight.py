...
model = dict(
    ...
    head=dict(
        ...
        branch_loss_weight={"decoder_gt": 1.0, "token_gt": 3.0, "decoder_predict": 0.3},
        predict_weight=True,
    ),
)
...
work_dir = "work_dir/beit3_multibranch/(3-10)decodergt#3.0decoderpredict#0.3tokengt_30ep_withweight"
