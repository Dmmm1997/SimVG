...
model = dict(
    ...
    head=dict(
        ...
        branch_loss_weight={"decoder_gt": 0.0, "token_gt": 3.0, "decoder_predict": 0.0},
...
work_dir = "work_dir/beit3_multibranch/(3-10)0.0decodergt#3.0decoderpredict#0.0tokengt_30ep_noweight"
