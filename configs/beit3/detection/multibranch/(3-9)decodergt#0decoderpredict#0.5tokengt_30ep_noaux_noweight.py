...
model = dict(
    ...
    head=dict(
        ...
        branch_loss_weight={"decoder_gt": 1.0, "token_gt": 0.0, "decoder_predict": 0.5},
...
work_dir = "work_dir/beit3_multibranch/(3-9)decodergt#0decoderpredict#0.5tokengt_30ep_noaux_noweight"
