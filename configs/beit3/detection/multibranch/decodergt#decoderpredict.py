...
model = dict(
    ...
    head=dict(
        ...
        only_decoder=True,
        text_embed_aug=True,
        target_type=["decoder_gt", "decoder_predict"],
        branch_loss_weight={"decoder_gt": 1.0, "decoder_predict": 1.0, "token_gt": 1.0},
    ),
)
...
work_dir = "work_dir/beit3_multibranch/decodergt#decoderpredict"
