...
model = dict(
    ...
    head=dict(
        ...
        branch_loss_weight={"decoder": 0.0, "token": 1.0, "distill": 1.0},
        distill_type="soft",
        decoder_freeze=True,
    ),
)
...
work_dir = "work_dir/beit3_multibranch/(3-12)1decoderpredict#1tokengt_30ep_noweight_freeze_b_d"
...
log_interval = 50
load_from = "work_dir/beit3_distill(3-9)decodergt#0decoderpredict#0tokengt_30ep_noweight/20240310_095533/latest.pth"