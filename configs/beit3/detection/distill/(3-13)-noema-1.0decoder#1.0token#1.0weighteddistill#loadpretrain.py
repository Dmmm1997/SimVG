...
model = dict(
    ...
    head=dict(
        ...
        branch_loss_weight={"decoder": 1.0, "token": 1.0, "distill":1.0},
...
work_dir = "work_dir/beit3_distill_313/(3-13)-noema-1.0decoder#1.0token#1.0weighteddistill#loadpretrain"
...
load_from = "work_dir/beit3_multibranch/(3-9)decodergt#0decoderpredict#0tokengt_30ep_noweight/20240310_095533/latest.pth"
