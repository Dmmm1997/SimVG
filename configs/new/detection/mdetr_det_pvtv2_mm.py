...
model = dict(
    ...
    fusion=dict(type="SimpleFusionv2", vis_chs=[128, 320, 512], fusion_dim=1024, direction="bottom_up"),
    head=dict(
        type="MDETRHead",
        in_ch=1024,
        num_bin=num_bin,
        ...
        query_positional_encoding=dict(type="LearnedPositionalEncoding1D", num_embedding=100, num_feature=d_model),
    ),
)
