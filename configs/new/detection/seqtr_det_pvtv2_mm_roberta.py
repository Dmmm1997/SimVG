...
model = dict(
    ...
    fusion=dict(type="SimpleFusionv2", vis_chs=[128, 320, 512], direction="bottom_up", fusion_dim=768),
    head=dict(
        type="SeqHead",
        in_ch=768,
        num_bin=num_bin,
...
optimizer_config = dict(type="Adam", lr=0.0005, lr_vis_enc=0.00005, lr_lan_enc=0.00005, betas=(0.9, 0.98), eps=1e-9, weight_decay=0, amsgrad=True)
