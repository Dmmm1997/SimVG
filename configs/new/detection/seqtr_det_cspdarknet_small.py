...
model = dict(
    ...
    vis_enc=dict(
        ...
        widen_factor=0.5,
        frozen_stages=3,
        init_cfg=dict(type="Pretrained", checkpoint="pretrain_weights/yolox_s_8x8_300e_coco_20211121_095711-4592a793.pth", prefix="backbone."),
    ),
    lan_enc=dict(
        type="LSTM",
    ...
    fusion=dict(type="SimpleFusionv2", vis_chs=[128, 256, 512], direction="bottom_up"),
    head=dict(
        type="SeqHead",
        in_ch=1024,
        num_bin=num_bin,
